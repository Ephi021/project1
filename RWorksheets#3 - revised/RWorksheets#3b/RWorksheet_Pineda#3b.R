...
HouseholdData <- read_csv("RWorksheets#3/RWorksheets#3b/HouseholdData.csv")
...
female_driver <- subset(HouseholdData,
                        Sex == "Female" & Fathers_Occupation == "Driver")
...
siblings_5up <- subset(HouseholdData,
                       Siblings_at_School >= 5)
